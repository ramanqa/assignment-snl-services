...
import com.snl.services.Boardv1Service;
...
public class Boardv1Test {
	...
	Boardv1Service boardObject = null;
	...
	public void call_class_Boardv1Service() {
		boardObject = new Boardv1Service();
	}
	...
	/**
	 * to verify if the absent player does not move
	 */
	@Test(priority = 5)
	public void verify_whether_absent_player_does_not_move_on_tile() {
		response = boardObject.service_call_to_move_absent_player();
